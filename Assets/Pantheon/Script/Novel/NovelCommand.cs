...
public class NovelCommand 
{
    ...
    {
        public NovelSystem system_;
        public NovelInfo info_;//info
        public NovelInfo.NovelModel model_;//command
    ...
    public class Group : NovelCommandInterface
    {
        ...
        {
            var groupName = share.model_.parameters[0];
            ...
            else
            {
                ...
                for (; variable.index < share.info_.NovelInfoList.Count; ++variable.index)
                {
                    var command = share.info_.NovelInfoList[variable.index];
    ...
    public class TextWrite : NovelCommandInterface
    {
        public IEnumerator Do(SharedData share, SharedVariable variable)
        {
            share.view.Text.text += variable.FindValue(share.model_.parameters[0]);
            yield break;
        }
    ...
    public class TextAnimationType : NovelCommandInterface
    {
        ...
        public IEnumerator Do(SharedData share, SharedVariable variable)
        {
            var fileName = share.model_.parameters[0];
    ...
    public class Image : NovelCommandInterface
    {
        public IEnumerator Do(SharedData share, SharedVariable variable)
        {
            var handleName = share.model_.parameters[0];
            var fileName = share.model_.parameters[1];
            var xRatio = share.model_.parameters[2].ParseFloat();
            var yRatio = share.model_.parameters[3].ParseFloat();
            var time = share.model_.parameters[4].ParseFloat();
    ...
    public class ImageRemove : NovelCommandInterface
    {
        ...
        {
            var handleName = share.model_.parameters[0];
            var time = share.model_.parameters[1].ParseFloat();
    ...
    public class ImageChange : NovelCommandInterface
    {
        ...
        public IEnumerator Do(SharedData share, SharedVariable variable)
        {
            var handleName = share.model_.parameters[0];
            var fileName = share.model_.parameters[1];
            var time = share.model_.parameters[2].ParseFloat();
    ...
    public class Jump : NovelCommandInterface
    {
        public IEnumerator Do(SharedData share, SharedVariable variable)
        {
            var jumpLabel = share.model_.parameters[0];

            for (variable.index++; variable.index < share.info_.NovelInfoList.Count; ++variable.index)
            {
                var command = share.info_.NovelInfoList[variable.index];
    ...
    public class Choices : NovelCommandInterface
    {
        ...
        {
            var fileName = share.model_.parameters[0];
            var buttonCount = share.model_.parameters[1].ParseInt();
            ...
            {
                var buttonName = share.model_.parameters[i * 2 + 2];
                var jumpLabel = share.model_.parameters[i * 2 + 3];
                ...
                button.onClick.AddListener(() => { share.system_.Event(jumpLabel); });
    ...
    public class WaitTime : NovelCommandInterface
    {
        public IEnumerator Do(SharedData share, SharedVariable variable)
        {
            var time = share.model_.parameters[0].ParseFloat();
    ...
    public class ValueAssign : NovelCommandInterface
    {
        ...
        public IEnumerator Do(SharedData share, SharedVariable variable)
        {
            var valueName = share.model_.parameters[0];
            var parameterString = share.model_.parameters[1];
